            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3>{{ $studentCount }}<sup style="font-size: 20px"></sup></h3>
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <ul class="inline pagination pagination-sm">
                        ...
                        <!-- /.box-body -->
                        <div class="clearfix box-footer no-border">
                ...
                <section class="col-lg-5 connectedSortable">
                    ...
                    <div class="box box-solid bg-light-blue-gradient">
                        ...
                        <div class="box-footer no-border">
                            <div class="row">
                                <div class="text-center col-xs-4" style="border-right: 1px solid #f4f4f4">
                    ...
                    <div class="box box-solid bg-green-gradient">
                        ...
                        <!-- /.box-body -->
                        <div class="text-black box-footer">
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Progress bars -->
                                    <div class="clearfix">
...
{{-- <div class="container">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="p-3 text-center rounded card bg-info text-dark">
                    <div class="card-body">
                        <h3 class="card-text counter" data-target="{{ $courseCount }}">
                            0
                        </h3>
                        <p class="text-white card-title fs-5">
