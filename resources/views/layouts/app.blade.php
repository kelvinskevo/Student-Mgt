        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-user-tie"></i> <span>Teachers</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> View</a>
                            </li>
                            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Register
                                </a></li>
                            <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Edit</a></li>
                        </ul>
                    </li>
